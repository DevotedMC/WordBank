...
public class NormalDistribution implements CharFunction {
	...
	/**
	 * Filter an assumed uniform input into a roughly guassian output, with no skew.
	 * 
	...
	public float process(Character[] input, String param) {
		...
		if (WordBank.config().isDebug()) WordBank.log().log(Level.INFO,"NormalDistro: {0} = {1}",
